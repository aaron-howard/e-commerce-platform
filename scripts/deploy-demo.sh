...
echo "   - Add environment variables (see LIVE_DEMO_SETUP.md)"
echo "   - Click 'Deploy'"
echo ""
echo "3. 🗄️ Set up Database:"
echo "   - Connect to your Railway PostgreSQL database"
echo "   - Run: cd server && npm run db:setup"
echo ""
echo "4. 🔗 Update Frontend URL:"
echo "   - Update REACT_APP_API_URL in Vercel with your Railway backend URL"
echo "   - Redeploy frontend"
echo ""
echo "📚 For detailed instructions, see LIVE_DEMO_SETUP.md"
echo ""
